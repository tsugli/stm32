...
AT91PS_SPI SPI = AT91C_BASE_SPI0;
...
void SPI_Init ( void )
{
  ...
  portENTER_CRITICAL();
  {
   ...
   AT91F_AIC_ConfigureIt ( AT91C_BASE_AIC, AT91C_ID_SPI0, SPI_INTERRUPT_LEVEL,AT91C_AIC_SRCTYPE_INT_LEVEL_SENSITIVE, AT91_SPI_ISR_ENTRY);
